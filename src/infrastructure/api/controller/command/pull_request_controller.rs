...
#[post("/c/pull-request/open", format = "application/json", data = "<data>")]
...
#[post("/c/pull-request/assign", format = "application/json", data = "<data>")]
...
#[post("/c/pull-request/close", format = "application/json", data = "<data>")]
